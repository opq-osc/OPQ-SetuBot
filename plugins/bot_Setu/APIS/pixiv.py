...
class PixivToken:
    ...
    def __init__(self):
        ...
        self.tokendata = {}
        self.Client = httpx.Client(proxies=jconfig.proxies)
...
class Pixiv:
    ...
    def get(self):  # p站热度榜
        ...
        headers['Authorization'] = 'Bearer {}'.format(pixivToken.tokendata['access_token'])
        try:
    ...
    def process_data(self, data) -> List[FinishSetuData]:
        ...
        for d in data['illusts']:
            ...
            dataList.append(FinishSetuData(
                title=d['title'],
                picID=d['id'],
                ...
                picOriginalUrl_Msg=self.buildOriginalUrl(OriginalUrl, d['page_count']),
