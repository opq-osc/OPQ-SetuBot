...
def get_imgurl_from_xpath(url):
    ...
    single_tag_xpath = '//*[@id="acgs-anime-list"]/div[1]/div[1]/div/div[3]/div[2]/div[2]/div[1]/tags[1]'  #单个tag地址，总tag地址为: //*[@id="acgs-anime-list"]/div[1]/div[1]/div/div[3]/div[2]/div[2]/div[1]
    try:
        # 发送 HTTP 请求并获取网页内容
